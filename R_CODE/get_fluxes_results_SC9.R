...
dir <- "D:/PROGRAMAS/Dropbox/shared/Metabolic_network_manual_curation/GAMS/FLUX_RESULTS/SC9"
...
write.csv(x_scenarios,paste0("D:/PROGRAMAS/Dropbox/shared/Metabolic_network_manual_curation/GAMS/FLUX_RESULTS/SC9/results/","PSEUDO_JOINED_SC9_A.csv"),na = "",row.names = F)
...
x_scenarios_j_flux$scenario <- sub("200_S9_","",x_scenarios_j_flux$scenario)
...
outdir <- "D:/PROGRAMAS/Dropbox/shared/Metabolic_network_manual_curation/GAMS/FLUX_RESULTS/SC9/results"
#concs$colors <- P36

ggexport(
  x_lines1,
  filename = paste0(outdir,"/","PSEUDO_TEST_SC9_A",".pdf"),
  #width = 35,
  width = 20,
  #height = 600,
  #pointsize = 0.1,
...
ggexport(
  xx,
  filename = paste0(outdir,"/","PSEUDO_TEST_hormone_growth_SC9_A",".pdf"),
  #width = 35,
  width = 20,
  #height = 300,
  #pointsize = 0.1,
...
ggexport(
  figure3,
  filename = paste0(outdir,"/","fluxes_selected_sc9_final_A.pdf"),
  width = 20,
  height = 20,
  #pointsize = 0.1,
  res = 600,
